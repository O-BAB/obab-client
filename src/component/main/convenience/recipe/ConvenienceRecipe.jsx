...
import styles from '../../../../css/main/convenience/recipe/convenienceRecipe.module.css';
    ...
    <div className={styles.convenience_recipe_con}>
      ...
      <div className={styles.container}>
        <div className={styles.element}>
          <img className={styles.convenience_recipe_img} src="./images/siteinfo/siteinfo.webp"
               alt="convenience_recipe"/>
