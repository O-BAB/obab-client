...
//           </IconButton>
//         </div>
//         <img className="w-2/3 mx-auto" src={category?.thumbnailUrl} alt="Thumbnail"/>
...
//           {category?.recipeIngredients?.map((ingredient, index) => (
//             <div key={index}
...
//
//       <div>
//         {category?.recipeSubItems?.map((data, index) => (
